  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Content style={{ padding: '24px 50px', background: token.colorBgLayout, margin: 0 }}>
        ...
        >
          ...
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            <UserInfoComponent userInfo={userInfo} onUserInfoChange={handleUserInfoChange} />
            <Card style={{ background: '#f0f7ff' }}>
              <Title level={3} id="investment-section">
                投资 <IconFont type="icon-investment" />
              </Title>
              <InvestSettings investOptions={investOptions} onInvestOptionsChange={handleInvestOptionsChange} />
            </Card>
      ...
      <Footer style={{ textAlign: 'center', color: 'white' }}>
        Future Fortune ©{new Date().getFullYear()} <br />
        Created by{' '}
        <a href="https://github.com/shiquda" target="_blank">
          shiquda
        </a>{' '}
        with ❤️
      </Footer>
